...
const WelcomeStep = ({ onNext }: { onNext: () => void }) => (
  <div className="flex flex-col items-center justify-center h-full animate-fade-in-up">
    <div className="relative mb-8">
      ...
      <div className="relative w-40 h-40 rounded-full border border-primary/30 flex items-center justify-center bg-primary/5 shadow-[0_0_40px_hsl(var(--primary)/0.15)]">
        <JarvisLogo size={110} className="text-primary" />
      </div>
    </div>
