  ...
  return (
    <div className="flex flex-col items-center gap-6">
      ...
      <div className="relative">
        {/* Outer rings */}
        <div className="absolute inset-[-30px] rounded-full border-2 border-primary/40 animate-ring-rotate" />
        <div className="absolute inset-[-48px] rounded-full border border-primary/25 animate-ring-rotate-reverse" />
        <div className="absolute inset-[-64px] rounded-full border border-primary/15 animate-ring-pulse" />
        ...
        {Array.from({ length: 24 }).map((_, i) => (
          ...
          >
            <div className="absolute top-[-30px] left-1/2 -translate-x-1/2 w-[1.5px] h-2.5 bg-primary/40" />
          </div>
        ))}
        ...
        <div
          ...
          style={{
            background: `radial-gradient(circle at 38% 32%, hsl(var(--primary) / 0.6), hsl(var(--primary) / 0.2) 50%, hsl(var(--background)) 100%)`,
            boxShadow: `0 0 80px hsl(var(--primary) / 0.35), 0 0 160px hsl(var(--primary) / 0.15), inset 0 0 60px hsl(var(--primary) / 0.1)`,
          }}
        >
          {/* Inner glass border */}
          <div className="absolute inset-[3px] rounded-full border-2 border-primary/25 bg-gradient-to-br from-primary/10 via-transparent to-primary/5" />

          {/* Core glow */}
          <div
            className="relative w-16 h-16 rounded-full"
            style={{
              background: `radial-gradient(circle, hsl(var(--primary)), hsl(var(--primary) / 0.3) 55%, transparent 100%)`,
