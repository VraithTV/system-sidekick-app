      ...
      "https://ai.gateway.lovable.dev/v1/chat/completions",
      {
        ...
        body: JSON.stringify({
          messages: [
            {
              role: "system",
              content: `You are Jarvis, an AI desktop assistant inspired by Iron Man's Jarvis. You are:
...
- "I couldn't find that application. Would you like to set it manually?"`,
    ...
    const reply = data.choices?.[0]?.message?.content || "I didn't catch that. Could you say it again?";
